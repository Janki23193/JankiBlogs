...
const Footer = () => {
  ...
  console.log(errors);
  return (
    <footer className='mt-16 rounded-xl bg-dark m-10 flex flex-col items-center text-light px-4'>
      ...
      <p className='mt-5 px-4 text-center w-3/5 font-light text-base'>
        Subscribe to learn new Technology jgkfdjg,gfdfgokdfpgompgtepyogptkg,mgkdfmgkofdgmkffgokfdotkofgmkdfjgoieeejjngdnguihsfs
      </p>
     ...
     <div className='flex items-center mt-5'>
        ...
        <a href='https://example.com' className='inline-block w-6 h-6 mr-4 fill-light'><GithubIcon className="hover:scale-125 transition-all ease duration-200 "/></a>
